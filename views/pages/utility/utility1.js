...
var modalImg = document.getElementById("utilityImage");
...
function initMap() {
    var map = new google.maps.Map(document.getElementById('map'), {
        zoom: 14,
        // Center of UCF - DEMO
        center: {lat: 28.602427, lng: -81.200060},
...
//  }
    ...
    google.maps.event.addListener(map, 'click', function(){
        var filename = "59677536bd647_132.jpg";
        if (selected == 1){
            document.getElementById("utilityImage").src="http://107.170.23.85/api/marker/getimage/" + filename;
...
//        });
    ...
    {
        document.getElementById("utilityImage").src=url;
    }
